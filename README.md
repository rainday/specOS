...
```
specOS/
?ú‚??Ä claude-code/          # Claude Code integration
??  ?ú‚??Ä agents/          # Specialized AI agents
??  ?î‚??Ä user/            # User configuration
?ú‚??Ä commands/            # Claude Code commands
?ú‚??Ä instructions/        # Workflow instructions
?ú‚??Ä standards/          # Development standards
?î‚??Ä setup.sh           # Installation script
```
...
- **?îß Bug Fixer**: Automatically detects and fixes code issues
